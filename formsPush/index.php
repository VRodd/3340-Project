...
<body>
  ...
  <button type="submit" class="newsletter-btn">Subscribe</button>
        ...
        <div style="display:flex; gap:48px; flex-wrap:wrap;">
          ...
          <div>
            <p style="font-size:12px; font-weight:600; letter-spacing:0.1em; text-transform:uppercase; color:var(--text-secondary); margin-bottom:12px;">Legal</p>
            <p style="margin-bottom:8px;"><a href="pages/shipping.html" style="font-size:14px; color:var(--text-secondary);">Shipping</a></p>
            <p style="margin-bottom:8px;"><a href="pages/returns.html" style="font-size:14px; color:var(--text-secondary);">Returns</a></p>
            <p style="margin-bottom:8px;"><a href="pages/privacy.html" style="font-size:14px; color:var(--text-secondary);">Privacy</a></p>
            <p style="margin-bottom:8px;"><a href="pages/terms.html" style="font-size:14px; color:var(--text-secondary);">Terms</a></p>
          </div>
        </div>
      </div>
    </div>
